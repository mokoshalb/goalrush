...
class Pagination{
    ...
    protected $curTagOpen    = '&nbsp;<li class="page-item active disabled"><a href="javascript:void(0);" class="page-link">';
    ...
    function createLinks(){ 
        ...
        if ($this->showCount){
           ...
           //$output .= $info; //uncomment to show, showing x no of x total
        }
        ...
        if($this->currentPage != 1){
            $i = ($uriPageNum - 1);
            if($i == 0) $i = '';
            $output .= $this->prevTagOpen.'<li class="page-item"><a tabindex="-1" class="page-link" href="'.$this->baseURL.$i.'">'.$this->prevLink.'</a></li>'.$this->prevTagClose;
        }
